        ...
        if(!empty($row)) {
            ...
            try {
                ...
                <div class='row'>
                            <div class='col-sm-12'>
                                <h4>$ship_name</h4><br>
                                <p>Hello $pssngr_fname, Thank you for making your reservation in our shipping line. Please  <a class='link' href='http://localhost/barkomatic-main/payment.php?reservetionId=$rsrvtn_num&&userId=$pssngr_id'>click me</a></p> to <b>Print your ticket</b
